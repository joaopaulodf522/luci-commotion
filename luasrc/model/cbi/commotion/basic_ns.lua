...
local m = Map("system", translate("Node Settings"), translate("In this section you'll set the basic required settings for this device, and the basic network settings. You will be prompted to save your settings along the way and apply them at the end."))
